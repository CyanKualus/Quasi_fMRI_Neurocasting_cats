"""One look for both halves of the application.

The EEG and the EMG tabs are written in two files, and they are read as one
screen: a colour, a corner radius or a font weight chosen twice is a colour, a
radius or a weight that will eventually be chosen differently. Everything the
window and its figures are drawn with is therefore named once here, and both
halves take it from the same place.
